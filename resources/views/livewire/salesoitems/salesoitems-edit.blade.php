<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Sales Order Items') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for edit Sales Order Items') }}</flux:subheading>
