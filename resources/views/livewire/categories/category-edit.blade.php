<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Product Category') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for edit product category ') }}</flux:subheading>
