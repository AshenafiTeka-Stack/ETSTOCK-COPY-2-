<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Stock Adjustment') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for create new stock adjustment ') }}</flux:subheading>
