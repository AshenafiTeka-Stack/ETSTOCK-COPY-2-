...
<div>
   ...
   @endsession
    ...
    class="cursor-pointer px-3 py-2 text-xs font-medium text-white bg-green-700 rounded-lg">Create Warehouse</a>
...
<div class="mt-4 overflow-x-auto">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tr>
            ...
            <th scope="col" class="px-6 py-3 w-80">Contact_Person</th>
        ...
        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
            <td class="px-6 py-2 font-medium text-gray-900 dark:text-white">{{ $warehouse->id }}</td>
            <td class="px-6 py-2 text-gray-600 dark:text-gray-300">{{ $warehouse->name }}</td>
            <td class="px-6 py-2 text-gray-600 dark:text-gray-300">{{ $warehouse->location }}</td>
            <td class="px-6 py-2 text-gray-600 dark:text-gray-300">{{ $warehouse->contact_person }}</td>
