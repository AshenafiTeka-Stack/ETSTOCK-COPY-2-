<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Supplier') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for create new supplier ') }}</flux:subheading>
...
<div class="mb-5">
    <form wire:submit="submit" class="mt-5 space-y-5 w-150" >
        ...
        <flux:input wire:model="contact_person" label="Contact_Person" placeholder="Spplier Contact Person" />
        ...
        <flux:textarea wire:model="address" label="Address" placeholder="Supplier address" />
